...
MSAA can be enabled in the Project Settings by changing the value of the [Rendering > Anti Aliasing > Quality > MSAA 3D](../godot_csharp_misc.md) setting. It's important to change the value of the **MSAA 3D** setting and not **MSAA 2D**, as these are entirely separate settings.
...
Temporal antialiasing can be enabled in the Project Settings by changing the value of the [Rendering > Anti Aliasing > Quality > TAA](../godot_csharp_misc.md) setting.
...
FXAA can be enabled in the Project Settings by changing the value of the [Rendering > Anti Aliasing > Quality > Screen Space AA](../godot_csharp_misc.md) setting to `FXAA`.
...
SMAA 1x can be enabled in the Project Settings by changing the value of the [Rendering > Anti Aliasing > Quality > Screen Space AA](../godot_csharp_misc.md) setting to `SMAA`.
...
- If using the Forward+ or Forward Mobile rendering methods, enable [Use Debanding](../godot_csharp_misc.md) in **Project Settings > Rendering > Anti Aliasing**. This applies a fullscreen debanding shader as a post-processing effect and is very cheap.
...
- [CSGBox3D](../godot_csharp_misc.md)
- [CSGCylinder3D](../godot_csharp_misc.md) (also supports cone)
- [CSGSphere3D](../godot_csharp_misc.md)
- [CSGTorus3D](../godot_csharp_misc.md)
- [CSGPolygon3D](../godot_csharp_misc.md)
- [CSGMesh3D](../godot_csharp_misc.md)
- [CSGCombiner3D](../godot_csharp_misc.md)
...
The [CSGPolygon3D](../godot_csharp_misc.md) node extrude along a Polygon drawn in 2D (in X, Y coordinates) in the following ways:
...
> **Note:** The **Path** mode must be provided with a [Path3D](../godot_csharp_nodes_3d.md) node to work. In the Path node, draw the path and the polygon in CSGPolygon3D will extrude along the given path.

#### Custom meshes

Custom meshes can be used for [CSGMesh3D](../godot_csharp_misc.md) as long as the mesh is _manifold_. The mesh can be modeled in other software and imported into Godot. Multiple materials are supported.
...
The [CSGCombiner3D](../godot_csharp_misc.md) node is an empty shape used for organization. It will only combine children nodes.
...
Since Godot 4.4, you can convert a CSG node and its children to a [MeshInstance3D](../godot_csharp_nodes_3d.md) node.
...
You can also create a trimesh collision shape using **CSG > Bake Collision Shape**. The generated [CollisionShape3D](../godot_csharp_physics.md) node must be a child of a [StaticBody3D](../godot_csharp_nodes_3d.md) or [AnimatableBody3D](../godot_csharp_nodes_3d.md) node to be effective.
