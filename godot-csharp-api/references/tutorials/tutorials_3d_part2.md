...
The [CameraAttributes](../godot_csharp_rendering.md) resource stores exposure and depth of field information. It also allows enabling automatic exposure adjustments depending on scene brightness.
...
> **Note:** Using a [CameraAttributesPhysical](../godot_csharp_rendering.md) on a Camera3D node will lock out FOV and aspect adjustments in that Camera3D, as field of view is adjusted in the CameraAttributesPhysical resource instead. If used in a WorldEnvironment, the CameraAttributesPhysical will not override any Camera3D in the scene.
...
- To enable HDR in 2D, open the Project Settings, enable [Rendering > Viewport > HDR 2D](../godot_csharp_misc.md) then restart the editor.
