# Godot 4 C# Tutorials — Navigation (Part 1)

> 10 tutorials. C#-specific code examples.
...
Debug visualizations are currently based on Nodes in the SceneTree. If the [NavigationServer2D](../godot_csharp_misc.md) or [NavigationServer3D](../godot_csharp_misc.md) APIs are used exclusively then changes will not be reflected by the debug navigation tools.
...
NavigationMeshSourceGeometryData3D sour
// ...
```
...
public partial class MyCharacterBody2D : CharacterBody2D
{
    ...
    public override void _Ready()
    {
        ...
        // Make sure to not await during _Read
// ...
```
...
2. Click on the region node and add a new [NavigationMesh](../godot_csharp_misc.md) Resource to the region node.
...
public partial class MyCharacterBody3D : CharacterBody3D
{
    ...
    public override void _Ready()
    {
        ...
        // Make sure to not await during _Re
// ...
```
...
2D and 3D version of NavigationAgents are available as [NavigationAgent2D](../godot_csharp_nodes_2d.md) and [NavigationAgent3D](../godot_csharp_nodes_3d.md) respectively.

New NavigationAgent nodes will automatically join the default navigation map on the [World2D](../godot_csharp_misc.md)/[World3D](../godot_csharp_misc.md).
...
public partial class MyRigidBody2D : RigidBody2D
{
    ...
    public override void _PhysicsProcess(double delta)
    {
        ...
        if (_navigationAgent.IsNavigationF
// ...
```
