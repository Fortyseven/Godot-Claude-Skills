# Godot 4 C# Tutorials — Export (Part 1)
...
You can find a full list of export options available in the [EditorExportPlatformAndroid](../godot_csharp_editor.md) class reference.

---

## Exporting for dedicated servers

If you want to run a dedicated server for your project on a machine that doesn't have a GPU or display server available, you'll need to run Godot with the `headless` display server and `Dummy` [audio driver](../godot_csharp_misc.md).
...
You can find a full list of export options available in the [EditorExportPlatformIOS](../godot_csharp_editor.md) class reference.
...
You can find a full list of export options available in the [EditorExportPlatformLinuxBSD](../godot_csharp_editor.md) class reference.
...
You can find a full list of export options available in the [EditorExportPlatformMacOS](../godot_csharp_editor.md) class reference.
