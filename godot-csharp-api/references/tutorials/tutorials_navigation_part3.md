# Godot 4 C# Tutorials — Navigation (Part 3)

> 1 tutorials. C#-specific code examples.

## Using NavigationServer

2D and 3D version of the NavigationServer are available as [NavigationServer2D](../godot_csharp_misc.md) and [NavigationServer3D](../godot_csharp_misc.md) respectively.
