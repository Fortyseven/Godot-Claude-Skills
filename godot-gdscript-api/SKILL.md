...
3. Answer using the loaded content. For broad questions, start with `godot_gdscript_core.md`.
...
If the query contains a **specific term, annotation, function, or pattern** (e.g., `@icon`, `@export_range`, `class_name`, `preload`, `EditorImportPlugin`):
