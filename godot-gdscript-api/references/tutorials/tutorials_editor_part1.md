# Godot 4 GDScript Tutorials — Editor (Part 1)
...
See the [EditorSettings](../godot_gdscript_filesystem.md) class reference for a complete description of most editor settings. You can also hover an editor setting's name with the mouse in the Editor Settings to show its description.
